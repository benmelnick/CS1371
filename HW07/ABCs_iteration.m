...
%    perfect squares between 1 and num1 inclusive. Store your answer in the
...
%    iteration, compare the value at the current index in the array to 
%    num2. If the value at this index is equivalent to num2, add one to the 
%    counter variable (G).
for i = 1:H
    for j = 1:I
        if arr(i,j) == num2
