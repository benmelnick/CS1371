...
figure('Name',??, 'NumberTitle','off','Color',??, 'Position',[420,218,690,432]); % (1)(2)

% TAKE A LOOK 1

% get the current figure
f = ??; % (3) what function does this?
% set the background color to black
f.Color = ??; % (4)

% creates a text box in the current figure
txt = uicontrol(f,??,'text','BackgroundColor','w'); %(5)
